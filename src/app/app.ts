        ...
        >
            ...
            >
                <button
                    ...
                    [attr.aria-current]="active_route() === 'directory' ? 'page' : null"
                >
            ...
            <main class="relative flex-1 overflow-hidden">
                <signage-player [hide]="hide_signage()" class="absolute inset-0" />
...
export class App implements OnInit {
    ...
    protected readonly active_route = toSignal(
    ...
    protected readonly hide_signage = computed(() =>
        ['directory', 'wayfinding'].includes(this.active_route()),
    );
